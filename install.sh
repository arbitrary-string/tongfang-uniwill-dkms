...
TCC_ARCHIVE_BASE="https://github.com/arbitrary-string/tuxedo-control-center/releases/download/v3.0.9-lightbar.9"
TCC_DEB="tuxedo-control-center_3.0.9-lightbar.9.deb"
